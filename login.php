                    ...
                    <form action="<?php $_PHP_SELF ?>" method="POST">
                        <div class="ml-5 mr-5">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="@correo.com" id="Mail" name="correo" required>
                            </div>
                            <div>
                                <label for="pwd" class="form-label">Contraseña:</label>
                                <input type="password" class="form-control boton-mover" placeholder="Contraseña" id="pwd" name="pwd" required>
                            </div>
                        </div>
                ...
                <div class="ml-5 mr-5">
                    <form action="<?php $_PHP_SELF ?>" method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <input type="email" class="form-control" placeholder="@correo.com" id="correo" name="correo" required>
                        </div>
                        <div class="mt-3">
                            <label for="pwd" class="form-label">Contraseña:</label>
